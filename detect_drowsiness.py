...
# ar_thresh to indicate blink and then a consec_frames constant for the number of consecutive
...
while True:
	...
	for rect in rects:
		...
		# check to see threshold, and if so, increment the blink frame counter
			...
			if COUNTER >= EYE_AR_CONSEC_FRAMES:
				...
				if not ALARM_ON:
					...
					if args["alarm"] != "":
						...
						if(i < num):
							i = i+1
							db.child("Drowsiness").child("drow").set(i)
						t.deamon = True
						t.start()
